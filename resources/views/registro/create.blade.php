                            ...
                            <div class="form-group mt-2">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" class="form-control" id="operaciones_tranf" name="operaciones_tranf" required>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mt-2">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" class="form-control" id="operaciones_tiendv" name="operaciones_tiendv" required>
                                    </div>
                                </div>
                            </div>
                        </div>
